...
<!--if the nibling isGirl is true, it gets the class "isGirl" etc.-->
...
<button on:click={() => onAskForAllowance(`Hey ${piblingName}. It's me ${nibling.name}. Can i have some allowance? `)}>Ask for Allowance</button>
